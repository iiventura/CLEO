# Generated by Django 2.2 on 2019-04-20 06:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion', models.CharField(blank=True, max_length=45, null=True)),
                ('telefono', models.CharField(blank=True, max_length=9, null=True)),
                ('tipoempleado', models.ForeignKey(db_column='tipoEmpleado_id', on_delete=django.db.models.deletion.DO_NOTHING, to='usuarios.TipoEmpleado')),
            ],
            options={
                'db_table': 'empleado',
